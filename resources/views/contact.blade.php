        ...
        <div class="container-fluid lead">
            <div class="row">
                <div class="col-12 col-md-12 p-3 p-md-5 text-center"> 
                    <img src="{{URL::asset('/uploads/rvs1.png')}}" class="img-fluid animate__animated animate__bounceInDown" />
                    <div class="p-3 p-md-5 ">
                    <h1>Pengumuman Tender & Lelang</h1>
                    <h3>Sabtu 24 April 2021</h3>
                    <p> 
                </div>
            </div>
            <div class="col-12 col-md-12 text-center">
                <div class="copyright text-center my-auto" style="font-size: 1em;"> 
                    ...
                    <a href="https://lavapos.vercel.app/" class="text-danger">LAVA</a>.
