<!DOCTYPE html><html lang="en">
    <head>
        ...
        <meta content='https://www.hockeycomputindo.com' property='og:author'/>
        <meta content='{{ $post->title }}' name='facebook:title'/>
        <meta content='website' property='og:type'/>
        <meta content='https://www.facebook.com/mesinkasircomplete' property='facebook:author'/>
        <meta content='{{ $post->image }}' name='facebook:image'/>
        <meta content='{{ $post->title }}' property='og:site_name'/>
        <meta content='{{ $post->subtitle }}' property='facebook:description'/>
        <meta content='summary_large_image' name='twitter:card'/>
        <meta content='https://twitter.com/hockeycomp' property='twitter:author'/>
        <meta content='@hockeycomp' name='twitter:site'/>
        <meta content='{{ $post->image }}' name='twitter:image'/>
        <meta content='{{ $post->subtitle }}' name='twitter:description'/>
        <meta content='{{ $post->title }}' name='twitter:title'/>
        <meta content='index, follow' name='robots'/>
        <meta name="author" content="https://www.hockeycomputindo.com">
