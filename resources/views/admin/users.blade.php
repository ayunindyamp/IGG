...
<style>
  ...
  <body>
    <div class="testbox">
      <form action="{{route('admin.pengumumans.store')}}" enctype="multipart/form-data" method="POST">
        @method('post')
        @csrf
        <h1>Pengumuman Tender dan Lelang</h1>
        <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
        <h4>Judul<span>*</span></h4>
        <input type="text" name="judul" />
        <h4>Upload File Pengumuman Tender&Lelang<span>*</span></h4>
